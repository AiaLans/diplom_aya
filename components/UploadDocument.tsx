...
const translations = {
  ru: {
    ...
    uploadTitle: 'Загрузить PDF файл',
    uploadDesc: 'Только файлы в формате PDF',
    submit: 'Загрузить',
    loading: 'Загружаем...',
    success: 'Документ успешно загружен и отправлен на проверку!',
  ...
  kz: {
    ...
    uploadTitle: 'PDF файлды жүктеу',
    uploadDesc: 'Тек PDF форматындағы файлдар',
    submit: 'Жүктеу',
    loading: 'Жүктелуде...',
    success: 'Құжат сәтті жүктелді және тексеруге жіберілді!',
